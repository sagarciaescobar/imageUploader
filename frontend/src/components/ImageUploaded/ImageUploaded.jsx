...
export default function ImageUploaded({ url }) {
    ...
    const handleClick = ()=>{
        navigator.clipboard.writeText("http://dev-image-uploader.herokuapp.com/" + url)
        setCopied(true)
	...
	return (
		<div className='uploaded_image_container'>
			...
			<img className="uploaded_image_container_img" src={"http://dev-image-uploader.herokuapp.com/" + url} alt='uploaded-img' />
			<div className='uploaded_image_container_link'>
				<p>{"http://dev-image-uploader.herokuapp.com/" + url}</p>
